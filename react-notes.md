- [React Notes](#react-notes)
  - [These will be notes that I take while completing the Codecademy "Create a Front-End App with React" Skill Path](#these-will-be-notes-that-i-take-while-completing-the-codecademy-create-a-front-end-app-with-react-skill-path)
    - [Class objects in Javascript](#class-objects-in-javascript)
  ...
  - [Intro to JSX](#intro-to-jsx)
    ...
    - [Use Javascript expressions in JSX](#use-javascript-expressions-in-jsx)
  - [React Components](#react-components)
    - [The render function](#the-render-function)
    - [Creating an instance](#creating-an-instance)
    - [Event listeners in components](#event-listeners-in-components)
  - [Components and Props](#components-and-props)
    - [Components in other components](#components-in-other-components)
    - [Component props](#component-props)
    - [Naming props](#naming-props)
    - [Children](#children)
    - [defaultProps](#defaultprops)
  - [Handling state in components](#handling-state-in-components)
    - [Stateless components from stateful components](#stateless-components-from-stateful-components)
    - [Note](#note)
    - [Child components update parent component state](#child-components-update-parent-component-state)
    - [Child components updating siblings](#child-components-updating-siblings)
  - [HTTP Requests](#http-requests)
    - [Making requests with REST](#making-requests-with-rest)
    - [HTTPS](#https)
    - [How to create an XHR GET request](#how-to-create-an-xhr-get-request)
    - [How to create an XHR POST request](#how-to-create-an-xhr-post-request)
  - [Making HTTP requests in ES6](#making-http-requests-in-es6)
    - [GET requests with `fetch()` using `promises`](#get-requests-with-fetch-using-promises)
    - [POST requests with `fetch()` and `promises`](#post-requests-with-fetch-and-promises)
    - [GET Requests using `async` `await`](#get-requests-using-async-await)
    - [POST requests using `async` `await`](#post-requests-using-async-await)
